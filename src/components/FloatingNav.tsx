  ...
  return (
    <div className="fixed bottom-4 inset-x-0 z-50 pointer-events-none">
      <div className="mx-auto w-full max-w-sm px-4">
        <nav className="pointer-events-auto bg-white/90 backdrop-blur border border-white/50 shadow-lg rounded-full px-3 py-2">
          <ul className="flex items-center justify-around text-gray-700">
            <li>
              <Link
                to="/"
                className="flex flex-col items-center gap-1 px-3 py-1.5 rounded-full hover:bg-gray-100"
                aria-label="Home"
              >
